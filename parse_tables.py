...
def extract_info_from_genomic_file(file_path,parsed_info):
    #The parsed_info is a dictionary of two fiels {'model': 'U1', 'assembly': 'GCA_015342455.1'}
    #The file is not tab separated, there is unspecified number of spaces between columns. Therefore, it is harder to parse the file.
...
directory_path = '/mnt/c/Users/kater/infernal/parse_tables_test/'
taxonomy_file = '/mnt/c/Users/kater/infernal/parse_tables_test/taxonomy.csv'
result_path = '/mnt/c/Users/kater/infernal/parse_tables_test/infernal_result.csv'
